...
var _Coin = __webpack_require__(54);

var _Coin2 = _interopRequireDefault(_Coin);

var _IndexValue = __webpack_require__(55);

var _IndexValue2 = _interopRequireDefault(_IndexValue);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.getPriceData = _this.getPriceData.bind(_this);
    _this.calculateIndexValue = _this.calculateIndexValue.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function getPriceData() {
      ...
      _axios2.default.get('/api/getPrices').then(function (data) {
        console.log('Got prices! ', data.data);
        _this2.setState({
          priceData: data.data
        }, function () {
          _this2.calculateIndexValue(_this2.state.priceData);
        });
      }).catch(function (err) {
    ...
    key: 'calculateIndexValue',
    value: function calculateIndexValue(arr) {
      var value = 0;
      var percentage = arr.length / 100;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_IndexValue2.default, { value: this.state.indexValue }),
        _react2.default.createElement(
          'div',
          { className: 'row' },
          this.state.priceData.map(function (coin, key) {
            return _react2.default.createElement(_Coin2.default, { coin: coin, key: coin.symbol });
          })
        )
      );
    }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              { className: 'card-text', style: parseFloat(this.props.coin.percent_change_24h) > 0 ? positiveChange : negativeChange },
              '24 hours: ',
              parseFloat(this.props.coin.percent_change_24h),
              '%'
            ),
            _react2.default.createElement(
              'p',
              { className: 'card-text', style: parseFloat(this.props.coin.percent_change_7d) > 0 ? positiveChange : negativeChange },
              '7 days: ',
              parseFloat(this.props.coin.percent_change_7d),
              '%'
            )
          )
        )
...
var IndexValue = function (_React$Component) {
  _inherits(IndexValue, _React$Component);

  function IndexValue(props) {
    _classCallCheck(this, IndexValue);

    return _possibleConstructorReturn(this, (IndexValue.__proto__ || Object.getPrototypeOf(IndexValue)).call(this, props));
  }

  _createClass(IndexValue, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
